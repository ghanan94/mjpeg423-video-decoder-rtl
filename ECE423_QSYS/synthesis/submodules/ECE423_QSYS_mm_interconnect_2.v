...
module ECE423_QSYS_mm_interconnect_2 (
		...
		input  wire        mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset, // mdma_from_idct_accel_reset_n_reset_bridge_in_reset.reset
		input  wire [28:0] mdma_from_idct_accel_mm_write_address,                    //                      mdma_from_idct_accel_mm_write.address
		output wire        mdma_from_idct_accel_mm_write_waitrequest,                //                                                   .waitrequest
		input  wire [7:0]  mdma_from_idct_accel_mm_write_burstcount,                 //                                                   .burstcount
		input  wire [3:0]  mdma_from_idct_accel_mm_write_byteenable,                 //                                                   .byteenable
		input  wire        mdma_from_idct_accel_mm_write_write,                      //                                                   .write
		input  wire [31:0] mdma_from_idct_accel_mm_write_writedata,                  //                                                   .writedata
		input  wire [28:0] mdma_from_ycbcr_to_rgb_accel_mm_write_address,            //              mdma_from_ycbcr_to_rgb_accel_mm_write.address
		output wire        mdma_from_ycbcr_to_rgb_accel_mm_write_waitrequest,        //                                                   .waitrequest
		input  wire [7:0]  mdma_from_ycbcr_to_rgb_accel_mm_write_burstcount,         //                                                   .burstcount
		input  wire [3:0]  mdma_from_ycbcr_to_rgb_accel_mm_write_byteenable,         //                                                   .byteenable
		input  wire        mdma_from_ycbcr_to_rgb_accel_mm_write_write,              //                                                   .write
		input  wire [31:0] mdma_from_ycbcr_to_rgb_accel_mm_write_writedata,          //                                                   .writedata
	...
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_waitrequest;           // mdma_from_idct_accel_mm_write_agent:av_waitrequest -> mdma_from_idct_accel_mm_write_translator:uav_waitrequest
	wire   [31:0] mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdata;              // mdma_from_idct_accel_mm_write_agent:av_readdata -> mdma_from_idct_accel_mm_write_translator:uav_readdata
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_debugaccess;           // mdma_from_idct_accel_mm_write_translator:uav_debugaccess -> mdma_from_idct_accel_mm_write_agent:av_debugaccess
	wire   [28:0] mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_address;               // mdma_from_idct_accel_mm_write_translator:uav_address -> mdma_from_idct_accel_mm_write_agent:av_address
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_read;                  // mdma_from_idct_accel_mm_write_translator:uav_read -> mdma_from_idct_accel_mm_write_agent:av_read
	wire    [3:0] mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_byteenable;            // mdma_from_idct_accel_mm_write_translator:uav_byteenable -> mdma_from_idct_accel_mm_write_agent:av_byteenable
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdatavalid;         // mdma_from_idct_accel_mm_write_agent:av_readdatavalid -> mdma_from_idct_accel_mm_write_translator:uav_readdatavalid
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_lock;                  // mdma_from_idct_accel_mm_write_translator:uav_lock -> mdma_from_idct_accel_mm_write_agent:av_lock
	wire          mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_write;                 // mdma_from_idct_accel_mm_write_translator:uav_write -> mdma_from_idct_accel_mm_write_agent:av_write
	wire   [31:0] mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_writedata;             // mdma_from_idct_accel_mm_write_translator:uav_writedata -> mdma_from_idct_accel_mm_write_agent:av_writedata
	wire    [9:0] mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_burstcount;            // mdma_from_idct_accel_mm_write_translator:uav_burstcount -> mdma_from_idct_accel_mm_write_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                        // rsp_mux:src_valid -> mdma_from_idct_accel_mm_write_agent:rp_valid
	wire  [105:0] rsp_mux_src_data;                                                                         // rsp_mux:src_data -> mdma_from_idct_accel_mm_write_agent:rp_data
	wire          rsp_mux_src_ready;                                                                        // mdma_from_idct_accel_mm_write_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                      // rsp_mux:src_channel -> mdma_from_idct_accel_mm_write_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                                // rsp_mux:src_startofpacket -> mdma_from_idct_accel_mm_write_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                  // rsp_mux:src_endofpacket -> mdma_from_idct_accel_mm_write_agent:rp_endofpacket
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_waitrequest;   // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_waitrequest -> mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_waitrequest
	wire   [31:0] mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdata;      // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_readdata -> mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_readdata
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_debugaccess;   // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_debugaccess -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_debugaccess
	wire   [28:0] mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_address;       // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_address -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_address
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_read;          // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_read -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_read
	wire    [3:0] mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_byteenable;    // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_byteenable -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_byteenable
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdatavalid; // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_readdatavalid -> mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_readdatavalid
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_lock;          // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_lock -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_lock
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_write;         // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_write -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_write
	wire   [31:0] mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_writedata;     // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_writedata -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_writedata
	wire    [9:0] mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_burstcount;    // mdma_from_ycbcr_to_rgb_accel_mm_write_translator:uav_burstcount -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                                    // rsp_mux_001:src_valid -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_valid
	wire  [105:0] rsp_mux_001_src_data;                                                                     // rsp_mux_001:src_data -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                    // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                                  // rsp_mux_001:src_channel -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                            // rsp_mux_001:src_startofpacket -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                              // rsp_mux_001:src_endofpacket -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:rp_endofpacket
	...
	wire          mdma_from_idct_accel_mm_write_agent_cp_valid;                                             // mdma_from_idct_accel_mm_write_agent:cp_valid -> router:sink_valid
	wire  [105:0] mdma_from_idct_accel_mm_write_agent_cp_data;                                              // mdma_from_idct_accel_mm_write_agent:cp_data -> router:sink_data
	wire          mdma_from_idct_accel_mm_write_agent_cp_ready;                                             // router:sink_ready -> mdma_from_idct_accel_mm_write_agent:cp_ready
	wire          mdma_from_idct_accel_mm_write_agent_cp_startofpacket;                                     // mdma_from_idct_accel_mm_write_agent:cp_startofpacket -> router:sink_startofpacket
	wire          mdma_from_idct_accel_mm_write_agent_cp_endofpacket;                                       // mdma_from_idct_accel_mm_write_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_valid;                                     // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:cp_valid -> router_001:sink_valid
	wire  [105:0] mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_data;                                      // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:cp_data -> router_001:sink_data
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_ready;                                     // router_001:sink_ready -> mdma_from_ycbcr_to_rgb_accel_mm_write_agent:cp_ready
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_startofpacket;                             // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_endofpacket;                               // mdma_from_ycbcr_to_rgb_accel_mm_write_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	) mdma_from_idct_accel_mm_write_translator (
		.clk                    (clk_125_clk_clk),                                                                  //                       clk.clk
		.reset                  (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset),                         //                     reset.reset
		.uav_address            (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (mdma_from_idct_accel_mm_write_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (mdma_from_idct_accel_mm_write_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (mdma_from_idct_accel_mm_write_burstcount),                                         //                          .burstcount
		.av_byteenable          (mdma_from_idct_accel_mm_write_byteenable),                                         //                          .byteenable
		.av_write               (mdma_from_idct_accel_mm_write_write),                                              //                          .write
		.av_writedata           (mdma_from_idct_accel_mm_write_writedata),                                          //                          .writedata
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) mdma_from_ycbcr_to_rgb_accel_mm_write_translator (
		.clk                    (clk_125_clk_clk),                                                                          //                       clk.clk
		.reset                  (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset),                                 //                     reset.reset
		.uav_address            (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (mdma_from_ycbcr_to_rgb_accel_mm_write_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (mdma_from_ycbcr_to_rgb_accel_mm_write_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (mdma_from_ycbcr_to_rgb_accel_mm_write_burstcount),                                         //                          .burstcount
		.av_byteenable          (mdma_from_ycbcr_to_rgb_accel_mm_write_byteenable),                                         //                          .byteenable
		.av_write               (mdma_from_ycbcr_to_rgb_accel_mm_write_write),                                              //                          .write
		.av_writedata           (mdma_from_ycbcr_to_rgb_accel_mm_write_writedata),                                          //                          .writedata
		.av_beginbursttransfer  (1'b0),                                                                                     //               (terminated)
		.av_begintransfer       (1'b0),                                                                                     //               (terminated)
		.av_chipselect          (1'b0),                                                                                     //               (terminated)
		.av_read                (1'b0),                                                                                     //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) mdma_from_idct_accel_mm_write_agent (
		.clk                   (clk_125_clk_clk),                                                                  //       clk.clk
		.reset                 (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset),                         // clk_reset.reset
		.av_address            (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (mdma_from_idct_accel_mm_write_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (mdma_from_idct_accel_mm_write_agent_cp_valid),                                     //        cp.valid
		.cp_data               (mdma_from_idct_accel_mm_write_agent_cp_data),                                      //          .data
		.cp_startofpacket      (mdma_from_idct_accel_mm_write_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (mdma_from_idct_accel_mm_write_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (mdma_from_idct_accel_mm_write_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) mdma_from_ycbcr_to_rgb_accel_mm_write_agent (
		.clk                   (clk_125_clk_clk),                                                                          //       clk.clk
		.reset                 (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset),                                 // clk_reset.reset
		.av_address            (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (mdma_from_ycbcr_to_rgb_accel_mm_write_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_valid),                                     //        cp.valid
		.cp_data               (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_data),                                      //          .data
		.cp_startofpacket      (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_ready),                                     //          .ready
	...
	ECE423_QSYS_mm_interconnect_2_router router (
		.sink_ready         (mdma_from_idct_accel_mm_write_agent_cp_ready),             //      sink.ready
		.sink_valid         (mdma_from_idct_accel_mm_write_agent_cp_valid),             //          .valid
		.sink_data          (mdma_from_idct_accel_mm_write_agent_cp_data),              //          .data
		.sink_startofpacket (mdma_from_idct_accel_mm_write_agent_cp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (mdma_from_idct_accel_mm_write_agent_cp_endofpacket),       //          .endofpacket
		.clk                (clk_125_clk_clk),                                          //       clk.clk
		.reset              (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_2_router router_001 (
		.sink_ready         (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_ready),         //      sink.ready
		.sink_valid         (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_valid),         //          .valid
		.sink_data          (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_data),          //          .data
		.sink_startofpacket (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (mdma_from_ycbcr_to_rgb_accel_mm_write_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_125_clk_clk),                                              //       clk.clk
		.reset              (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	altera_avalon_st_pipeline_stage #(
		...
		.reset             (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset), // cr0_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (mdma_from_idct_accel_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset

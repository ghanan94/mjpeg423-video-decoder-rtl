...
module ECE423_QSYS_lpddr2_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (14336),
		.INIT_FILE        ("ECE423_QSYS_lpddr2_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ECE423_QSYS_lpddr2_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	ECE423_QSYS_lpddr2_s0_mm_interconnect_1 mm_interconnect_1 (
		.avl_clk_out_clk_clk                             (avl_clk),                                                   //                           avl_clk_out_clk.clk
	...
	ECE423_QSYS_lpddr2_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk

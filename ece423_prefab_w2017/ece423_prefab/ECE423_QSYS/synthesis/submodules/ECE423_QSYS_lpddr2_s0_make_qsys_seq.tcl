...
lappend arg_list "--component-param=DELAY_PER_OPA_TAP=378"
...
lappend arg_list "--component-param=AFI_ADDRESS_WIDTH=20"
...
lappend arg_list "--component-param=MEM_TINIT_CK=66001"
...
lappend arg_list "--component-param=SEQ_ROM=ECE423_QSYS_lpddr2_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ECE423_QSYS_lpddr2_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ECE423_QSYS_lpddr2_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=AVL_CLK_PS=15152"
lappend arg_list "--component-param=AFI_CLK_PS=3030"
...
lappend arg_list "--output-name=ECE423_QSYS_lpddr2_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:ECE423_QSYS_lpddr2_s0.sopcinfo"
lappend arg_list "--report-file=txt:ECE423_QSYS_lpddr2_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "C:/altera/15.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp

...
module ECE423_QSYS_mm_interconnect_0 (
	...
	wire   [29:0] lpddr2_avl_0_agent_m0_address;                                             // lpddr2_avl_0_agent:m0_address -> lpddr2_avl_0_translator:uav_address
	...
	wire  [115:0] lpddr2_avl_0_agent_rf_source_data;                                         // lpddr2_avl_0_agent:rf_source_data -> lpddr2_avl_0_agent_rsp_fifo:in_data
	...
	wire  [115:0] lpddr2_avl_0_agent_rsp_fifo_out_data;                                      // lpddr2_avl_0_agent_rsp_fifo:out_data -> lpddr2_avl_0_agent:rf_sink_data
	...
	wire  [115:0] timer_0_s1_agent_rf_source_data;                                           // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] timer_0_s1_agent_rsp_fifo_out_data;                                        // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [115:0] timer_1_s1_agent_rf_source_data;                                           // timer_1_s1_agent:rf_source_data -> timer_1_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] timer_1_s1_agent_rsp_fifo_out_data;                                        // timer_1_s1_agent_rsp_fifo:out_data -> timer_1_s1_agent:rf_sink_data
	...
	wire   [29:0] ledg_s1_agent_m0_address;                                                  // ledg_s1_agent:m0_address -> ledg_s1_translator:uav_address
	...
	wire  [115:0] ledg_s1_agent_rf_source_data;                                              // ledg_s1_agent:rf_source_data -> ledg_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] ledg_s1_agent_rsp_fifo_out_data;                                           // ledg_s1_agent_rsp_fifo:out_data -> ledg_s1_agent:rf_sink_data
	...
	wire   [29:0] ledr_s1_agent_m0_address;                                                  // ledr_s1_agent:m0_address -> ledr_s1_translator:uav_address
	...
	wire  [115:0] ledr_s1_agent_rf_source_data;                                              // ledr_s1_agent:rf_source_data -> ledr_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] ledr_s1_agent_rsp_fifo_out_data;                                           // ledr_s1_agent_rsp_fifo:out_data -> ledr_s1_agent:rf_sink_data
	...
	wire   [29:0] i2c_scl_s1_agent_m0_address;                                               // i2c_scl_s1_agent:m0_address -> i2c_scl_s1_translator:uav_address
	...
	wire  [115:0] i2c_scl_s1_agent_rf_source_data;                                           // i2c_scl_s1_agent:rf_source_data -> i2c_scl_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] i2c_scl_s1_agent_rsp_fifo_out_data;                                        // i2c_scl_s1_agent_rsp_fifo:out_data -> i2c_scl_s1_agent:rf_sink_data
	...
	wire   [29:0] i2c_sda_s1_agent_m0_address;                                               // i2c_sda_s1_agent:m0_address -> i2c_sda_s1_translator:uav_address
	...
	wire  [115:0] i2c_sda_s1_agent_rf_source_data;                                           // i2c_sda_s1_agent:rf_source_data -> i2c_sda_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] i2c_sda_s1_agent_rsp_fifo_out_data;                                        // i2c_sda_s1_agent_rsp_fifo:out_data -> i2c_sda_s1_agent:rf_sink_data
	...
	wire   [29:0] sram_uas_agent_m0_address;                                                 // sram_uas_agent:m0_address -> sram_uas_translator:uav_address
	...
	wire   [97:0] sram_uas_agent_rf_source_data;                                             // sram_uas_agent:rf_source_data -> sram_uas_agent_rsp_fifo:in_data
	...
	wire   [97:0] sram_uas_agent_rsp_fifo_out_data;                                          // sram_uas_agent_rsp_fifo:out_data -> sram_uas_agent:rf_sink_data
	...
	wire  [114:0] router_003_src_data;                                                       // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [114:0] router_004_src_data;                                                       // router_004:src_data -> rsp_demux_002:sink_data
	...
	wire  [114:0] router_005_src_data;                                                       // router_005:src_data -> rsp_demux_003:sink_data
	...
	wire  [114:0] router_006_src_data;                                                       // router_006:src_data -> rsp_demux_004:sink_data
	...
	wire  [114:0] router_007_src_data;                                                       // router_007:src_data -> rsp_demux_005:sink_data
	...
	wire  [114:0] router_008_src_data;                                                       // router_008:src_data -> rsp_demux_006:sink_data
	...
	wire  [114:0] router_009_src_data;                                                       // router_009:src_data -> rsp_demux_007:sink_data
	...
	wire  [114:0] router_010_src_data;                                                       // router_010:src_data -> rsp_demux_008:sink_data
	...
	wire  [114:0] router_011_src_data;                                                       // router_011:src_data -> rsp_demux_009:sink_data
	...
	wire  [114:0] router_012_src_data;                                                       // router_012:src_data -> rsp_demux_010:sink_data
	...
	wire  [114:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire  [114:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> sysid_control_slave_burst_adapter:sink0_data
	...
	wire   [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> cpu_debug_mem_slave_burst_adapter:sink0_channel
	...
	wire  [114:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> timer_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                     // timer_0_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire   [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> timer_0_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> key_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> key_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                     // key_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire   [11:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> key_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> timer_1_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                     // timer_1_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire   [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> timer_1_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> timer_1_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> timer_1_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> ledg_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> ledg_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                     // ledg_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire   [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> ledg_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> ledg_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> ledg_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> ledr_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> ledr_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                     // ledr_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire   [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> ledr_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> ledr_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> ledr_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> i2c_scl_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> i2c_scl_s1_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                                     // i2c_scl_s1_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire   [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> i2c_scl_s1_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> i2c_scl_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> i2c_scl_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> i2c_sda_s1_burst_adapter:sink0_valid
	wire  [114:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> i2c_sda_s1_burst_adapter:sink0_data
	wire          cmd_mux_010_src_ready;                                                     // i2c_sda_s1_burst_adapter:sink0_ready -> cmd_mux_010:src_ready
	wire   [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> i2c_sda_s1_burst_adapter:sink0_channel
	wire          cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> i2c_sda_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> i2c_sda_s1_burst_adapter:sink0_endofpacket
	wire          router_013_src_valid;                                                      // router_013:src_valid -> sram_uas_rsp_width_adapter:in_valid
	wire   [96:0] router_013_src_data;                                                       // router_013:src_data -> sram_uas_rsp_width_adapter:in_data
	wire          router_013_src_ready;                                                      // sram_uas_rsp_width_adapter:in_ready -> router_013:src_ready
	wire   [11:0] router_013_src_channel;                                                    // router_013:src_channel -> sram_uas_rsp_width_adapter:in_channel
	wire          router_013_src_startofpacket;                                              // router_013:src_startofpacket -> sram_uas_rsp_width_adapter:in_startofpacket
	wire          router_013_src_endofpacket;                                                // router_013:src_endofpacket -> sram_uas_rsp_width_adapter:in_endofpacket
	wire          sram_uas_rsp_width_adapter_src_valid;                                      // sram_uas_rsp_width_adapter:out_valid -> rsp_demux_011:sink_valid
	wire  [114:0] sram_uas_rsp_width_adapter_src_data;                                       // sram_uas_rsp_width_adapter:out_data -> rsp_demux_011:sink_data
	wire          sram_uas_rsp_width_adapter_src_ready;                                      // rsp_demux_011:sink_ready -> sram_uas_rsp_width_adapter:out_ready
	wire   [11:0] sram_uas_rsp_width_adapter_src_channel;                                    // sram_uas_rsp_width_adapter:out_channel -> rsp_demux_011:sink_channel
	wire          sram_uas_rsp_width_adapter_src_startofpacket;                              // sram_uas_rsp_width_adapter:out_startofpacket -> rsp_demux_011:sink_startofpacket
	wire          sram_uas_rsp_width_adapter_src_endofpacket;                                // sram_uas_rsp_width_adapter:out_endofpacket -> rsp_demux_011:sink_endofpacket
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> sram_uas_cmd_width_adapter:in_valid
	wire  [114:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> sram_uas_cmd_width_adapter:in_data
	wire          cmd_mux_011_src_ready;                                                     // sram_uas_cmd_width_adapter:in_ready -> cmd_mux_011:src_ready
	wire   [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> sram_uas_cmd_width_adapter:in_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> sram_uas_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> sram_uas_cmd_width_adapter:in_endofpacket
	wire          sram_uas_cmd_width_adapter_src_valid;                                      // sram_uas_cmd_width_adapter:out_valid -> sram_uas_burst_adapter:sink0_valid
	wire   [96:0] sram_uas_cmd_width_adapter_src_data;                                       // sram_uas_cmd_width_adapter:out_data -> sram_uas_burst_adapter:sink0_data
	wire          sram_uas_cmd_width_adapter_src_ready;                                      // sram_uas_burst_adapter:sink0_ready -> sram_uas_cmd_width_adapter:out_ready
	wire   [11:0] sram_uas_cmd_width_adapter_src_channel;                                    // sram_uas_cmd_width_adapter:out_channel -> sram_uas_burst_adapter:sink0_channel
	...
	wire  [114:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          cpu_data_master_limiter_cmd_src_ready;                                     // limiter_pipeline:in_ready -> cpu_data_master_limiter:cmd_src_ready
	wire   [11:0] cpu_data_master_limiter_cmd_src_channel;                                   // cpu_data_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	...
	wire  [114:0] limiter_pipeline_source0_data;                                             // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [114:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire  [114:0] limiter_pipeline_001_source0_data;                                         // limiter_pipeline_001:out_data -> cpu_data_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                        // cpu_data_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire   [11:0] limiter_pipeline_001_source0_channel;                                      // limiter_pipeline_001:out_channel -> cpu_data_master_limiter:rsp_sink_channel
	...
	wire  [114:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> limiter_pipeline_002:in_data
	...
	wire   [11:0] cpu_instruction_master_limiter_cmd_src_channel;                            // cpu_instruction_master_limiter:cmd_src_channel -> limiter_pipeline_002:in_channel
	...
	wire  [114:0] limiter_pipeline_002_source0_data;                                         // limiter_pipeline_002:out_data -> cmd_demux_001:sink_data
	...
	wire  [114:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> limiter_pipeline_003:in_data
	...
	wire  [114:0] limiter_pipeline_003_source0_data;                                         // limiter_pipeline_003:out_data -> cpu_instruction_master_limiter:rsp_sink_data
	wire          limiter_pipeline_003_source0_ready;                                        // cpu_instruction_master_limiter:rsp_sink_ready -> limiter_pipeline_003:out_ready
	wire   [11:0] limiter_pipeline_003_source0_channel;                                      // limiter_pipeline_003:out_channel -> cpu_instruction_master_limiter:rsp_sink_channel
	...
	wire  [114:0] jtag_uart_avalon_jtag_slave_burst_adapter_source0_data;                    // jtag_uart_avalon_jtag_slave_burst_adapter:source0_data -> agent_pipeline:in_data
	...
	wire   [11:0] jtag_uart_avalon_jtag_slave_burst_adapter_source0_channel;                 // jtag_uart_avalon_jtag_slave_burst_adapter:source0_channel -> agent_pipeline:in_channel
	...
	wire  [114:0] agent_pipeline_source0_data;                                               // agent_pipeline:out_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	wire          agent_pipeline_source0_ready;                                              // jtag_uart_avalon_jtag_slave_agent:cp_ready -> agent_pipeline:out_ready
	wire   [11:0] agent_pipeline_source0_channel;                                            // agent_pipeline:out_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire  [114:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                 // jtag_uart_avalon_jtag_slave_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire  [114:0] agent_pipeline_001_source0_data;                                           // agent_pipeline_001:out_data -> router_002:sink_data
	...
	wire  [114:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> agent_pipeline_002:in_data
	wire          cmd_mux_001_src_ready;                                                     // agent_pipeline_002:in_ready -> cmd_mux_001:src_ready
	wire   [11:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> agent_pipeline_002:in_channel
	...
	wire  [114:0] agent_pipeline_002_source0_data;                                           // agent_pipeline_002:out_data -> lpddr2_avl_0_agent:cp_data
	wire          agent_pipeline_002_source0_ready;                                          // lpddr2_avl_0_agent:cp_ready -> agent_pipeline_002:out_ready
	wire   [11:0] agent_pipeline_002_source0_channel;                                        // agent_pipeline_002:out_channel -> lpddr2_avl_0_agent:cp_channel
	...
	wire  [114:0] lpddr2_avl_0_agent_rp_data;                                                // lpddr2_avl_0_agent:rp_data -> agent_pipeline_003:in_data
	...
	wire  [114:0] agent_pipeline_003_source0_data;                                           // agent_pipeline_003:out_data -> router_003:sink_data
	...
	wire  [114:0] sysid_control_slave_burst_adapter_source0_data;                            // sysid_control_slave_burst_adapter:source0_data -> agent_pipeline_004:in_data
	...
	wire   [11:0] sysid_control_slave_burst_adapter_source0_channel;                         // sysid_control_slave_burst_adapter:source0_channel -> agent_pipeline_004:in_channel
	...
	wire  [114:0] agent_pipeline_004_source0_data;                                           // agent_pipeline_004:out_data -> sysid_control_slave_agent:cp_data
	wire          agent_pipeline_004_source0_ready;                                          // sysid_control_slave_agent:cp_ready -> agent_pipeline_004:out_ready
	wire   [11:0] agent_pipeline_004_source0_channel;                                        // agent_pipeline_004:out_channel -> sysid_control_slave_agent:cp_channel
	...
	wire  [114:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> agent_pipeline_005:in_data
	...
	wire  [114:0] agent_pipeline_005_source0_data;                                           // agent_pipeline_005:out_data -> router_004:sink_data
	...
	wire          cpu_debug_mem_slave_burst_adapter_source0_valid;                           // cpu_debug_mem_slave_burst_adapter:source0_valid -> agent_pipeline_006:in_valid
	wire  [114:0] cpu_debug_mem_slave_burst_adapter_source0_data;                            // cpu_debug_mem_slave_burst_adapter:source0_data -> agent_pipeline_006:in_data
	wire          cpu_debug_mem_slave_burst_adapter_source0_ready;                           // agent_pipeline_006:in_ready -> cpu_debug_mem_slave_burst_adapter:source0_ready
	wire   [11:0] cpu_debug_mem_slave_burst_adapter_source0_channel;                         // cpu_debug_mem_slave_burst_adapter:source0_channel -> agent_pipeline_006:in_channel
	wire          cpu_debug_mem_slave_burst_adapter_source0_startofpacket;                   // cpu_debug_mem_slave_burst_adapter:source0_startofpacket -> agent_pipeline_006:in_startofpacket
	wire          cpu_debug_mem_slave_burst_adapter_source0_endofpacket;                     // cpu_debug_mem_slave_burst_adapter:source0_endofpacket -> agent_pipeline_006:in_endofpacket
	wire          agent_pipeline_006_source0_valid;                                          // agent_pipeline_006:out_valid -> cpu_debug_mem_slave_agent:cp_valid
	wire  [114:0] agent_pipeline_006_source0_data;                                           // agent_pipeline_006:out_data -> cpu_debug_mem_slave_agent:cp_data
	wire          agent_pipeline_006_source0_ready;                                          // cpu_debug_mem_slave_agent:cp_ready -> agent_pipeline_006:out_ready
	wire   [11:0] agent_pipeline_006_source0_channel;                                        // agent_pipeline_006:out_channel -> cpu_debug_mem_slave_agent:cp_channel
	wire          agent_pipeline_006_source0_startofpacket;                                  // agent_pipeline_006:out_startofpacket -> cpu_debug_mem_slave_agent:cp_startofpacket
	wire          agent_pipeline_006_source0_endofpacket;                                    // agent_pipeline_006:out_endofpacket -> cpu_debug_mem_slave_agent:cp_endofpacket
	wire          cpu_debug_mem_slave_agent_rp_valid;                                        // cpu_debug_mem_slave_agent:rp_valid -> agent_pipeline_007:in_valid
	wire  [114:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> agent_pipeline_007:in_data
	wire          cpu_debug_mem_slave_agent_rp_ready;                                        // agent_pipeline_007:in_ready -> cpu_debug_mem_slave_agent:rp_ready
	wire          cpu_debug_mem_slave_agent_rp_startofpacket;                                // cpu_debug_mem_slave_agent:rp_startofpacket -> agent_pipeline_007:in_startofpacket
	wire          cpu_debug_mem_slave_agent_rp_endofpacket;                                  // cpu_debug_mem_slave_agent:rp_endofpacket -> agent_pipeline_007:in_endofpacket
	wire          agent_pipeline_007_source0_valid;                                          // agent_pipeline_007:out_valid -> router_005:sink_valid
	wire  [114:0] agent_pipeline_007_source0_data;                                           // agent_pipeline_007:out_data -> router_005:sink_data
	...
	wire          timer_0_s1_burst_adapter_source0_valid;                                    // timer_0_s1_burst_adapter:source0_valid -> agent_pipeline_008:in_valid
	wire  [114:0] timer_0_s1_burst_adapter_source0_data;                                     // timer_0_s1_burst_adapter:source0_data -> agent_pipeline_008:in_data
	wire          timer_0_s1_burst_adapter_source0_ready;                                    // agent_pipeline_008:in_ready -> timer_0_s1_burst_adapter:source0_ready
	wire   [11:0] timer_0_s1_burst_adapter_source0_channel;                                  // timer_0_s1_burst_adapter:source0_channel -> agent_pipeline_008:in_channel
	wire          timer_0_s1_burst_adapter_source0_startofpacket;                            // timer_0_s1_burst_adapter:source0_startofpacket -> agent_pipeline_008:in_startofpacket
	wire          timer_0_s1_burst_adapter_source0_endofpacket;                              // timer_0_s1_burst_adapter:source0_endofpacket -> agent_pipeline_008:in_endofpacket
	wire          agent_pipeline_008_source0_valid;                                          // agent_pipeline_008:out_valid -> timer_0_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_008_source0_data;                                           // agent_pipeline_008:out_data -> timer_0_s1_agent:cp_data
	wire          agent_pipeline_008_source0_ready;                                          // timer_0_s1_agent:cp_ready -> agent_pipeline_008:out_ready
	wire   [11:0] agent_pipeline_008_source0_channel;                                        // agent_pipeline_008:out_channel -> timer_0_s1_agent:cp_channel
	wire          agent_pipeline_008_source0_startofpacket;                                  // agent_pipeline_008:out_startofpacket -> timer_0_s1_agent:cp_startofpacket
	wire          agent_pipeline_008_source0_endofpacket;                                    // agent_pipeline_008:out_endofpacket -> timer_0_s1_agent:cp_endofpacket
	wire          timer_0_s1_agent_rp_valid;                                                 // timer_0_s1_agent:rp_valid -> agent_pipeline_009:in_valid
	wire  [114:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> agent_pipeline_009:in_data
	wire          timer_0_s1_agent_rp_ready;                                                 // agent_pipeline_009:in_ready -> timer_0_s1_agent:rp_ready
	wire          timer_0_s1_agent_rp_startofpacket;                                         // timer_0_s1_agent:rp_startofpacket -> agent_pipeline_009:in_startofpacket
	wire          timer_0_s1_agent_rp_endofpacket;                                           // timer_0_s1_agent:rp_endofpacket -> agent_pipeline_009:in_endofpacket
	wire          agent_pipeline_009_source0_valid;                                          // agent_pipeline_009:out_valid -> router_006:sink_valid
	wire  [114:0] agent_pipeline_009_source0_data;                                           // agent_pipeline_009:out_data -> router_006:sink_data
	...
	wire          key_s1_burst_adapter_source0_valid;                                        // key_s1_burst_adapter:source0_valid -> agent_pipeline_010:in_valid
	wire  [114:0] key_s1_burst_adapter_source0_data;                                         // key_s1_burst_adapter:source0_data -> agent_pipeline_010:in_data
	wire          key_s1_burst_adapter_source0_ready;                                        // agent_pipeline_010:in_ready -> key_s1_burst_adapter:source0_ready
	wire   [11:0] key_s1_burst_adapter_source0_channel;                                      // key_s1_burst_adapter:source0_channel -> agent_pipeline_010:in_channel
	wire          key_s1_burst_adapter_source0_startofpacket;                                // key_s1_burst_adapter:source0_startofpacket -> agent_pipeline_010:in_startofpacket
	wire          key_s1_burst_adapter_source0_endofpacket;                                  // key_s1_burst_adapter:source0_endofpacket -> agent_pipeline_010:in_endofpacket
	wire          agent_pipeline_010_source0_valid;                                          // agent_pipeline_010:out_valid -> key_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_010_source0_data;                                           // agent_pipeline_010:out_data -> key_s1_agent:cp_data
	wire          agent_pipeline_010_source0_ready;                                          // key_s1_agent:cp_ready -> agent_pipeline_010:out_ready
	wire   [11:0] agent_pipeline_010_source0_channel;                                        // agent_pipeline_010:out_channel -> key_s1_agent:cp_channel
	wire          agent_pipeline_010_source0_startofpacket;                                  // agent_pipeline_010:out_startofpacket -> key_s1_agent:cp_startofpacket
	wire          agent_pipeline_010_source0_endofpacket;                                    // agent_pipeline_010:out_endofpacket -> key_s1_agent:cp_endofpacket
	wire          key_s1_agent_rp_valid;                                                     // key_s1_agent:rp_valid -> agent_pipeline_011:in_valid
	wire  [114:0] key_s1_agent_rp_data;                                                      // key_s1_agent:rp_data -> agent_pipeline_011:in_data
	wire          key_s1_agent_rp_ready;                                                     // agent_pipeline_011:in_ready -> key_s1_agent:rp_ready
	wire          key_s1_agent_rp_startofpacket;                                             // key_s1_agent:rp_startofpacket -> agent_pipeline_011:in_startofpacket
	wire          key_s1_agent_rp_endofpacket;                                               // key_s1_agent:rp_endofpacket -> agent_pipeline_011:in_endofpacket
	wire          agent_pipeline_011_source0_valid;                                          // agent_pipeline_011:out_valid -> router_007:sink_valid
	wire  [114:0] agent_pipeline_011_source0_data;                                           // agent_pipeline_011:out_data -> router_007:sink_data
	...
	wire          timer_1_s1_burst_adapter_source0_valid;                                    // timer_1_s1_burst_adapter:source0_valid -> agent_pipeline_012:in_valid
	wire  [114:0] timer_1_s1_burst_adapter_source0_data;                                     // timer_1_s1_burst_adapter:source0_data -> agent_pipeline_012:in_data
	wire          timer_1_s1_burst_adapter_source0_ready;                                    // agent_pipeline_012:in_ready -> timer_1_s1_burst_adapter:source0_ready
	wire   [11:0] timer_1_s1_burst_adapter_source0_channel;                                  // timer_1_s1_burst_adapter:source0_channel -> agent_pipeline_012:in_channel
	wire          timer_1_s1_burst_adapter_source0_startofpacket;                            // timer_1_s1_burst_adapter:source0_startofpacket -> agent_pipeline_012:in_startofpacket
	wire          timer_1_s1_burst_adapter_source0_endofpacket;                              // timer_1_s1_burst_adapter:source0_endofpacket -> agent_pipeline_012:in_endofpacket
	wire          agent_pipeline_012_source0_valid;                                          // agent_pipeline_012:out_valid -> timer_1_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_012_source0_data;                                           // agent_pipeline_012:out_data -> timer_1_s1_agent:cp_data
	wire          agent_pipeline_012_source0_ready;                                          // timer_1_s1_agent:cp_ready -> agent_pipeline_012:out_ready
	wire   [11:0] agent_pipeline_012_source0_channel;                                        // agent_pipeline_012:out_channel -> timer_1_s1_agent:cp_channel
	wire          agent_pipeline_012_source0_startofpacket;                                  // agent_pipeline_012:out_startofpacket -> timer_1_s1_agent:cp_startofpacket
	wire          agent_pipeline_012_source0_endofpacket;                                    // agent_pipeline_012:out_endofpacket -> timer_1_s1_agent:cp_endofpacket
	wire          timer_1_s1_agent_rp_valid;                                                 // timer_1_s1_agent:rp_valid -> agent_pipeline_013:in_valid
	wire  [114:0] timer_1_s1_agent_rp_data;                                                  // timer_1_s1_agent:rp_data -> agent_pipeline_013:in_data
	wire          timer_1_s1_agent_rp_ready;                                                 // agent_pipeline_013:in_ready -> timer_1_s1_agent:rp_ready
	wire          timer_1_s1_agent_rp_startofpacket;                                         // timer_1_s1_agent:rp_startofpacket -> agent_pipeline_013:in_startofpacket
	wire          timer_1_s1_agent_rp_endofpacket;                                           // timer_1_s1_agent:rp_endofpacket -> agent_pipeline_013:in_endofpacket
	wire          agent_pipeline_013_source0_valid;                                          // agent_pipeline_013:out_valid -> router_008:sink_valid
	wire  [114:0] agent_pipeline_013_source0_data;                                           // agent_pipeline_013:out_data -> router_008:sink_data
	...
	wire          ledg_s1_burst_adapter_source0_valid;                                       // ledg_s1_burst_adapter:source0_valid -> agent_pipeline_014:in_valid
	wire  [114:0] ledg_s1_burst_adapter_source0_data;                                        // ledg_s1_burst_adapter:source0_data -> agent_pipeline_014:in_data
	wire          ledg_s1_burst_adapter_source0_ready;                                       // agent_pipeline_014:in_ready -> ledg_s1_burst_adapter:source0_ready
	wire   [11:0] ledg_s1_burst_adapter_source0_channel;                                     // ledg_s1_burst_adapter:source0_channel -> agent_pipeline_014:in_channel
	wire          ledg_s1_burst_adapter_source0_startofpacket;                               // ledg_s1_burst_adapter:source0_startofpacket -> agent_pipeline_014:in_startofpacket
	wire          ledg_s1_burst_adapter_source0_endofpacket;                                 // ledg_s1_burst_adapter:source0_endofpacket -> agent_pipeline_014:in_endofpacket
	wire          agent_pipeline_014_source0_valid;                                          // agent_pipeline_014:out_valid -> ledg_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_014_source0_data;                                           // agent_pipeline_014:out_data -> ledg_s1_agent:cp_data
	wire          agent_pipeline_014_source0_ready;                                          // ledg_s1_agent:cp_ready -> agent_pipeline_014:out_ready
	wire   [11:0] agent_pipeline_014_source0_channel;                                        // agent_pipeline_014:out_channel -> ledg_s1_agent:cp_channel
	wire          agent_pipeline_014_source0_startofpacket;                                  // agent_pipeline_014:out_startofpacket -> ledg_s1_agent:cp_startofpacket
	wire          agent_pipeline_014_source0_endofpacket;                                    // agent_pipeline_014:out_endofpacket -> ledg_s1_agent:cp_endofpacket
	wire          ledg_s1_agent_rp_valid;                                                    // ledg_s1_agent:rp_valid -> agent_pipeline_015:in_valid
	wire  [114:0] ledg_s1_agent_rp_data;                                                     // ledg_s1_agent:rp_data -> agent_pipeline_015:in_data
	wire          ledg_s1_agent_rp_ready;                                                    // agent_pipeline_015:in_ready -> ledg_s1_agent:rp_ready
	wire          ledg_s1_agent_rp_startofpacket;                                            // ledg_s1_agent:rp_startofpacket -> agent_pipeline_015:in_startofpacket
	wire          ledg_s1_agent_rp_endofpacket;                                              // ledg_s1_agent:rp_endofpacket -> agent_pipeline_015:in_endofpacket
	wire          agent_pipeline_015_source0_valid;                                          // agent_pipeline_015:out_valid -> router_009:sink_valid
	wire  [114:0] agent_pipeline_015_source0_data;                                           // agent_pipeline_015:out_data -> router_009:sink_data
	...
	wire          ledr_s1_burst_adapter_source0_valid;                                       // ledr_s1_burst_adapter:source0_valid -> agent_pipeline_016:in_valid
	wire  [114:0] ledr_s1_burst_adapter_source0_data;                                        // ledr_s1_burst_adapter:source0_data -> agent_pipeline_016:in_data
	wire          ledr_s1_burst_adapter_source0_ready;                                       // agent_pipeline_016:in_ready -> ledr_s1_burst_adapter:source0_ready
	wire   [11:0] ledr_s1_burst_adapter_source0_channel;                                     // ledr_s1_burst_adapter:source0_channel -> agent_pipeline_016:in_channel
	wire          ledr_s1_burst_adapter_source0_startofpacket;                               // ledr_s1_burst_adapter:source0_startofpacket -> agent_pipeline_016:in_startofpacket
	wire          ledr_s1_burst_adapter_source0_endofpacket;                                 // ledr_s1_burst_adapter:source0_endofpacket -> agent_pipeline_016:in_endofpacket
	wire          agent_pipeline_016_source0_valid;                                          // agent_pipeline_016:out_valid -> ledr_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_016_source0_data;                                           // agent_pipeline_016:out_data -> ledr_s1_agent:cp_data
	wire          agent_pipeline_016_source0_ready;                                          // ledr_s1_agent:cp_ready -> agent_pipeline_016:out_ready
	wire   [11:0] agent_pipeline_016_source0_channel;                                        // agent_pipeline_016:out_channel -> ledr_s1_agent:cp_channel
	wire          agent_pipeline_016_source0_startofpacket;                                  // agent_pipeline_016:out_startofpacket -> ledr_s1_agent:cp_startofpacket
	wire          agent_pipeline_016_source0_endofpacket;                                    // agent_pipeline_016:out_endofpacket -> ledr_s1_agent:cp_endofpacket
	wire          ledr_s1_agent_rp_valid;                                                    // ledr_s1_agent:rp_valid -> agent_pipeline_017:in_valid
	wire  [114:0] ledr_s1_agent_rp_data;                                                     // ledr_s1_agent:rp_data -> agent_pipeline_017:in_data
	wire          ledr_s1_agent_rp_ready;                                                    // agent_pipeline_017:in_ready -> ledr_s1_agent:rp_ready
	wire          ledr_s1_agent_rp_startofpacket;                                            // ledr_s1_agent:rp_startofpacket -> agent_pipeline_017:in_startofpacket
	wire          ledr_s1_agent_rp_endofpacket;                                              // ledr_s1_agent:rp_endofpacket -> agent_pipeline_017:in_endofpacket
	wire          agent_pipeline_017_source0_valid;                                          // agent_pipeline_017:out_valid -> router_010:sink_valid
	wire  [114:0] agent_pipeline_017_source0_data;                                           // agent_pipeline_017:out_data -> router_010:sink_data
	...
	wire          i2c_scl_s1_burst_adapter_source0_valid;                                    // i2c_scl_s1_burst_adapter:source0_valid -> agent_pipeline_018:in_valid
	wire  [114:0] i2c_scl_s1_burst_adapter_source0_data;                                     // i2c_scl_s1_burst_adapter:source0_data -> agent_pipeline_018:in_data
	wire          i2c_scl_s1_burst_adapter_source0_ready;                                    // agent_pipeline_018:in_ready -> i2c_scl_s1_burst_adapter:source0_ready
	wire   [11:0] i2c_scl_s1_burst_adapter_source0_channel;                                  // i2c_scl_s1_burst_adapter:source0_channel -> agent_pipeline_018:in_channel
	wire          i2c_scl_s1_burst_adapter_source0_startofpacket;                            // i2c_scl_s1_burst_adapter:source0_startofpacket -> agent_pipeline_018:in_startofpacket
	wire          i2c_scl_s1_burst_adapter_source0_endofpacket;                              // i2c_scl_s1_burst_adapter:source0_endofpacket -> agent_pipeline_018:in_endofpacket
	wire          agent_pipeline_018_source0_valid;                                          // agent_pipeline_018:out_valid -> i2c_scl_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_018_source0_data;                                           // agent_pipeline_018:out_data -> i2c_scl_s1_agent:cp_data
	wire          agent_pipeline_018_source0_ready;                                          // i2c_scl_s1_agent:cp_ready -> agent_pipeline_018:out_ready
	wire   [11:0] agent_pipeline_018_source0_channel;                                        // agent_pipeline_018:out_channel -> i2c_scl_s1_agent:cp_channel
	wire          agent_pipeline_018_source0_startofpacket;                                  // agent_pipeline_018:out_startofpacket -> i2c_scl_s1_agent:cp_startofpacket
	wire          agent_pipeline_018_source0_endofpacket;                                    // agent_pipeline_018:out_endofpacket -> i2c_scl_s1_agent:cp_endofpacket
	wire          i2c_scl_s1_agent_rp_valid;                                                 // i2c_scl_s1_agent:rp_valid -> agent_pipeline_019:in_valid
	wire  [114:0] i2c_scl_s1_agent_rp_data;                                                  // i2c_scl_s1_agent:rp_data -> agent_pipeline_019:in_data
	wire          i2c_scl_s1_agent_rp_ready;                                                 // agent_pipeline_019:in_ready -> i2c_scl_s1_agent:rp_ready
	wire          i2c_scl_s1_agent_rp_startofpacket;                                         // i2c_scl_s1_agent:rp_startofpacket -> agent_pipeline_019:in_startofpacket
	wire          i2c_scl_s1_agent_rp_endofpacket;                                           // i2c_scl_s1_agent:rp_endofpacket -> agent_pipeline_019:in_endofpacket
	wire          agent_pipeline_019_source0_valid;                                          // agent_pipeline_019:out_valid -> router_011:sink_valid
	wire  [114:0] agent_pipeline_019_source0_data;                                           // agent_pipeline_019:out_data -> router_011:sink_data
	...
	wire          i2c_sda_s1_burst_adapter_source0_valid;                                    // i2c_sda_s1_burst_adapter:source0_valid -> agent_pipeline_020:in_valid
	wire  [114:0] i2c_sda_s1_burst_adapter_source0_data;                                     // i2c_sda_s1_burst_adapter:source0_data -> agent_pipeline_020:in_data
	wire          i2c_sda_s1_burst_adapter_source0_ready;                                    // agent_pipeline_020:in_ready -> i2c_sda_s1_burst_adapter:source0_ready
	wire   [11:0] i2c_sda_s1_burst_adapter_source0_channel;                                  // i2c_sda_s1_burst_adapter:source0_channel -> agent_pipeline_020:in_channel
	wire          i2c_sda_s1_burst_adapter_source0_startofpacket;                            // i2c_sda_s1_burst_adapter:source0_startofpacket -> agent_pipeline_020:in_startofpacket
	wire          i2c_sda_s1_burst_adapter_source0_endofpacket;                              // i2c_sda_s1_burst_adapter:source0_endofpacket -> agent_pipeline_020:in_endofpacket
	wire          agent_pipeline_020_source0_valid;                                          // agent_pipeline_020:out_valid -> i2c_sda_s1_agent:cp_valid
	wire  [114:0] agent_pipeline_020_source0_data;                                           // agent_pipeline_020:out_data -> i2c_sda_s1_agent:cp_data
	wire          agent_pipeline_020_source0_ready;                                          // i2c_sda_s1_agent:cp_ready -> agent_pipeline_020:out_ready
	wire   [11:0] agent_pipeline_020_source0_channel;                                        // agent_pipeline_020:out_channel -> i2c_sda_s1_agent:cp_channel
	wire          agent_pipeline_020_source0_startofpacket;                                  // agent_pipeline_020:out_startofpacket -> i2c_sda_s1_agent:cp_startofpacket
	wire          agent_pipeline_020_source0_endofpacket;                                    // agent_pipeline_020:out_endofpacket -> i2c_sda_s1_agent:cp_endofpacket
	wire          i2c_sda_s1_agent_rp_valid;                                                 // i2c_sda_s1_agent:rp_valid -> agent_pipeline_021:in_valid
	wire  [114:0] i2c_sda_s1_agent_rp_data;                                                  // i2c_sda_s1_agent:rp_data -> agent_pipeline_021:in_data
	wire          i2c_sda_s1_agent_rp_ready;                                                 // agent_pipeline_021:in_ready -> i2c_sda_s1_agent:rp_ready
	wire          i2c_sda_s1_agent_rp_startofpacket;                                         // i2c_sda_s1_agent:rp_startofpacket -> agent_pipeline_021:in_startofpacket
	wire          i2c_sda_s1_agent_rp_endofpacket;                                           // i2c_sda_s1_agent:rp_endofpacket -> agent_pipeline_021:in_endofpacket
	wire          agent_pipeline_021_source0_valid;                                          // agent_pipeline_021:out_valid -> router_012:sink_valid
	wire  [114:0] agent_pipeline_021_source0_data;                                           // agent_pipeline_021:out_data -> router_012:sink_data
	...
	wire          sram_uas_burst_adapter_source0_valid;                                      // sram_uas_burst_adapter:source0_valid -> agent_pipeline_022:in_valid
	wire   [96:0] sram_uas_burst_adapter_source0_data;                                       // sram_uas_burst_adapter:source0_data -> agent_pipeline_022:in_data
	wire          sram_uas_burst_adapter_source0_ready;                                      // agent_pipeline_022:in_ready -> sram_uas_burst_adapter:source0_ready
	wire   [11:0] sram_uas_burst_adapter_source0_channel;                                    // sram_uas_burst_adapter:source0_channel -> agent_pipeline_022:in_channel
	wire          sram_uas_burst_adapter_source0_startofpacket;                              // sram_uas_burst_adapter:source0_startofpacket -> agent_pipeline_022:in_startofpacket
	wire          sram_uas_burst_adapter_source0_endofpacket;                                // sram_uas_burst_adapter:source0_endofpacket -> agent_pipeline_022:in_endofpacket
	wire          agent_pipeline_022_source0_valid;                                          // agent_pipeline_022:out_valid -> sram_uas_agent:cp_valid
	wire   [96:0] agent_pipeline_022_source0_data;                                           // agent_pipeline_022:out_data -> sram_uas_agent:cp_data
	wire          agent_pipeline_022_source0_ready;                                          // sram_uas_agent:cp_ready -> agent_pipeline_022:out_ready
	wire   [11:0] agent_pipeline_022_source0_channel;                                        // agent_pipeline_022:out_channel -> sram_uas_agent:cp_channel
	wire          agent_pipeline_022_source0_startofpacket;                                  // agent_pipeline_022:out_startofpacket -> sram_uas_agent:cp_startofpacket
	wire          agent_pipeline_022_source0_endofpacket;                                    // agent_pipeline_022:out_endofpacket -> sram_uas_agent:cp_endofpacket
	wire          sram_uas_agent_rp_valid;                                                   // sram_uas_agent:rp_valid -> agent_pipeline_023:in_valid
	wire   [96:0] sram_uas_agent_rp_data;                                                    // sram_uas_agent:rp_data -> agent_pipeline_023:in_data
	wire          sram_uas_agent_rp_ready;                                                   // agent_pipeline_023:in_ready -> sram_uas_agent:rp_ready
	wire          sram_uas_agent_rp_startofpacket;                                           // sram_uas_agent:rp_startofpacket -> agent_pipeline_023:in_startofpacket
	wire          sram_uas_agent_rp_endofpacket;                                             // sram_uas_agent:rp_endofpacket -> agent_pipeline_023:in_endofpacket
	wire          agent_pipeline_023_source0_valid;                                          // agent_pipeline_023:out_valid -> router_013:sink_valid
	wire   [96:0] agent_pipeline_023_source0_data;                                           // agent_pipeline_023:out_data -> router_013:sink_data
	...
	wire  [114:0] cmd_demux_src0_data;                                                       // cmd_demux:src0_data -> mux_pipeline:in_data
	...
	wire  [114:0] cmd_demux_src1_data;                                                       // cmd_demux:src1_data -> mux_pipeline_001:in_data
	wire          cmd_demux_src1_ready;                                                      // mux_pipeline_001:in_ready -> cmd_demux:src1_ready
	wire   [11:0] cmd_demux_src1_channel;                                                    // cmd_demux:src1_channel -> mux_pipeline_001:in_channel
	...
	wire  [114:0] mux_pipeline_001_source0_data;                                             // mux_pipeline_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [114:0] cmd_demux_src2_data;                                                       // cmd_demux:src2_data -> mux_pipeline_002:in_data
	wire          cmd_demux_src2_ready;                                                      // mux_pipeline_002:in_ready -> cmd_demux:src2_ready
	wire   [11:0] cmd_demux_src2_channel;                                                    // cmd_demux:src2_channel -> mux_pipeline_002:in_channel
	...
	wire  [114:0] mux_pipeline_002_source0_data;                                             // mux_pipeline_002:out_data -> cmd_mux_002:sink0_data
	...
	wire  [114:0] cmd_demux_src3_data;                                                       // cmd_demux:src3_data -> mux_pipeline_003:in_data
	wire          cmd_demux_src3_ready;                                                      // mux_pipeline_003:in_ready -> cmd_demux:src3_ready
	wire   [11:0] cmd_demux_src3_channel;                                                    // cmd_demux:src3_channel -> mux_pipeline_003:in_channel
	...
	wire  [114:0] mux_pipeline_003_source0_data;                                             // mux_pipeline_003:out_data -> cmd_mux_003:sink0_data
	...
	wire          cmd_demux_001_src0_valid;                                                  // cmd_demux_001:src0_valid -> mux_pipeline_004:in_valid
	wire  [114:0] cmd_demux_001_src0_data;                                                   // cmd_demux_001:src0_data -> mux_pipeline_004:in_data
	wire          cmd_demux_001_src0_ready;                                                  // mux_pipeline_004:in_ready -> cmd_demux_001:src0_ready
	wire   [11:0] cmd_demux_001_src0_channel;                                                // cmd_demux_001:src0_channel -> mux_pipeline_004:in_channel
	wire          cmd_demux_001_src0_startofpacket;                                          // cmd_demux_001:src0_startofpacket -> mux_pipeline_004:in_startofpacket
	wire          cmd_demux_001_src0_endofpacket;                                            // cmd_demux_001:src0_endofpacket -> mux_pipeline_004:in_endofpacket
	wire          mux_pipeline_004_source0_valid;                                            // mux_pipeline_004:out_valid -> cmd_mux_003:sink1_valid
	wire  [114:0] mux_pipeline_004_source0_data;                                             // mux_pipeline_004:out_data -> cmd_mux_003:sink1_data
	wire          mux_pipeline_004_source0_ready;                                            // cmd_mux_003:sink1_ready -> mux_pipeline_004:out_ready
	wire   [11:0] mux_pipeline_004_source0_channel;                                          // mux_pipeline_004:out_channel -> cmd_mux_003:sink1_channel
	wire          mux_pipeline_004_source0_startofpacket;                                    // mux_pipeline_004:out_startofpacket -> cmd_mux_003:sink1_startofpacket
	wire          mux_pipeline_004_source0_endofpacket;                                      // mux_pipeline_004:out_endofpacket -> cmd_mux_003:sink1_endofpacket
	wire          cmd_demux_src4_valid;                                                      // cmd_demux:src4_valid -> mux_pipeline_005:in_valid
	wire  [114:0] cmd_demux_src4_data;                                                       // cmd_demux:src4_data -> mux_pipeline_005:in_data
	wire          cmd_demux_src4_ready;                                                      // mux_pipeline_005:in_ready -> cmd_demux:src4_ready
	wire   [11:0] cmd_demux_src4_channel;                                                    // cmd_demux:src4_channel -> mux_pipeline_005:in_channel
	...
	wire  [114:0] mux_pipeline_005_source0_data;                                             // mux_pipeline_005:out_data -> cmd_mux_004:sink0_data
	wire          mux_pipeline_005_source0_ready;                                            // cmd_mux_004:sink0_ready -> mux_pipeline_005:out_ready
	wire   [11:0] mux_pipeline_005_source0_channel;                                          // mux_pipeline_005:out_channel -> cmd_mux_004:sink0_channel
	...
	wire  [114:0] cmd_demux_src5_data;                                                       // cmd_demux:src5_data -> mux_pipeline_006:in_data
	wire          cmd_demux_src5_ready;                                                      // mux_pipeline_006:in_ready -> cmd_demux:src5_ready
	wire   [11:0] cmd_demux_src5_channel;                                                    // cmd_demux:src5_channel -> mux_pipeline_006:in_channel
	...
	wire  [114:0] mux_pipeline_006_source0_data;                                             // mux_pipeline_006:out_data -> cmd_mux_005:sink0_data
	wire          mux_pipeline_006_source0_ready;                                            // cmd_mux_005:sink0_ready -> mux_pipeline_006:out_ready
	wire   [11:0] mux_pipeline_006_source0_channel;                                          // mux_pipeline_006:out_channel -> cmd_mux_005:sink0_channel
	...
	wire  [114:0] cmd_demux_src6_data;                                                       // cmd_demux:src6_data -> mux_pipeline_007:in_data
	wire          cmd_demux_src6_ready;                                                      // mux_pipeline_007:in_ready -> cmd_demux:src6_ready
	wire   [11:0] cmd_demux_src6_channel;                                                    // cmd_demux:src6_channel -> mux_pipeline_007:in_channel
	...
	wire  [114:0] mux_pipeline_007_source0_data;                                             // mux_pipeline_007:out_data -> cmd_mux_006:sink0_data
	wire          mux_pipeline_007_source0_ready;                                            // cmd_mux_006:sink0_ready -> mux_pipeline_007:out_ready
	wire   [11:0] mux_pipeline_007_source0_channel;                                          // mux_pipeline_007:out_channel -> cmd_mux_006:sink0_channel
	...
	wire  [114:0] cmd_demux_src7_data;                                                       // cmd_demux:src7_data -> mux_pipeline_008:in_data
	wire          cmd_demux_src7_ready;                                                      // mux_pipeline_008:in_ready -> cmd_demux:src7_ready
	wire   [11:0] cmd_demux_src7_channel;                                                    // cmd_demux:src7_channel -> mux_pipeline_008:in_channel
	...
	wire  [114:0] mux_pipeline_008_source0_data;                                             // mux_pipeline_008:out_data -> cmd_mux_007:sink0_data
	wire          mux_pipeline_008_source0_ready;                                            // cmd_mux_007:sink0_ready -> mux_pipeline_008:out_ready
	wire   [11:0] mux_pipeline_008_source0_channel;                                          // mux_pipeline_008:out_channel -> cmd_mux_007:sink0_channel
	...
	wire  [114:0] cmd_demux_src8_data;                                                       // cmd_demux:src8_data -> mux_pipeline_009:in_data
	wire          cmd_demux_src8_ready;                                                      // mux_pipeline_009:in_ready -> cmd_demux:src8_ready
	wire   [11:0] cmd_demux_src8_channel;                                                    // cmd_demux:src8_channel -> mux_pipeline_009:in_channel
	...
	wire  [114:0] mux_pipeline_009_source0_data;                                             // mux_pipeline_009:out_data -> cmd_mux_008:sink0_data
	wire          mux_pipeline_009_source0_ready;                                            // cmd_mux_008:sink0_ready -> mux_pipeline_009:out_ready
	wire   [11:0] mux_pipeline_009_source0_channel;                                          // mux_pipeline_009:out_channel -> cmd_mux_008:sink0_channel
	...
	wire  [114:0] cmd_demux_src9_data;                                                       // cmd_demux:src9_data -> mux_pipeline_010:in_data
	wire          cmd_demux_src9_ready;                                                      // mux_pipeline_010:in_ready -> cmd_demux:src9_ready
	wire   [11:0] cmd_demux_src9_channel;                                                    // cmd_demux:src9_channel -> mux_pipeline_010:in_channel
	...
	wire  [114:0] mux_pipeline_010_source0_data;                                             // mux_pipeline_010:out_data -> cmd_mux_009:sink0_data
	...
	wire          cmd_demux_src10_valid;                                                     // cmd_demux:src10_valid -> mux_pipeline_011:in_valid
	wire  [114:0] cmd_demux_src10_data;                                                      // cmd_demux:src10_data -> mux_pipeline_011:in_data
	wire          cmd_demux_src10_ready;                                                     // mux_pipeline_011:in_ready -> cmd_demux:src10_ready
	wire   [11:0] cmd_demux_src10_channel;                                                   // cmd_demux:src10_channel -> mux_pipeline_011:in_channel
	wire          cmd_demux_src10_startofpacket;                                             // cmd_demux:src10_startofpacket -> mux_pipeline_011:in_startofpacket
	wire          cmd_demux_src10_endofpacket;                                               // cmd_demux:src10_endofpacket -> mux_pipeline_011:in_endofpacket
	wire          mux_pipeline_011_source0_valid;                                            // mux_pipeline_011:out_valid -> cmd_mux_010:sink0_valid
	wire  [114:0] mux_pipeline_011_source0_data;                                             // mux_pipeline_011:out_data -> cmd_mux_010:sink0_data
	wire          mux_pipeline_011_source0_ready;                                            // cmd_mux_010:sink0_ready -> mux_pipeline_011:out_ready
	wire   [11:0] mux_pipeline_011_source0_channel;                                          // mux_pipeline_011:out_channel -> cmd_mux_010:sink0_channel
	wire          mux_pipeline_011_source0_startofpacket;                                    // mux_pipeline_011:out_startofpacket -> cmd_mux_010:sink0_startofpacket
	wire          mux_pipeline_011_source0_endofpacket;                                      // mux_pipeline_011:out_endofpacket -> cmd_mux_010:sink0_endofpacket
	wire          cmd_demux_src11_valid;                                                     // cmd_demux:src11_valid -> mux_pipeline_012:in_valid
	wire  [114:0] cmd_demux_src11_data;                                                      // cmd_demux:src11_data -> mux_pipeline_012:in_data
	wire          cmd_demux_src11_ready;                                                     // mux_pipeline_012:in_ready -> cmd_demux:src11_ready
	wire   [11:0] cmd_demux_src11_channel;                                                   // cmd_demux:src11_channel -> mux_pipeline_012:in_channel
	wire          cmd_demux_src11_startofpacket;                                             // cmd_demux:src11_startofpacket -> mux_pipeline_012:in_startofpacket
	wire          cmd_demux_src11_endofpacket;                                               // cmd_demux:src11_endofpacket -> mux_pipeline_012:in_endofpacket
	wire          mux_pipeline_012_source0_valid;                                            // mux_pipeline_012:out_valid -> cmd_mux_011:sink0_valid
	wire  [114:0] mux_pipeline_012_source0_data;                                             // mux_pipeline_012:out_data -> cmd_mux_011:sink0_data
	wire          mux_pipeline_012_source0_ready;                                            // cmd_mux_011:sink0_ready -> mux_pipeline_012:out_ready
	wire   [11:0] mux_pipeline_012_source0_channel;                                          // mux_pipeline_012:out_channel -> cmd_mux_011:sink0_channel
	wire          mux_pipeline_012_source0_startofpacket;                                    // mux_pipeline_012:out_startofpacket -> cmd_mux_011:sink0_startofpacket
	wire          mux_pipeline_012_source0_endofpacket;                                      // mux_pipeline_012:out_endofpacket -> cmd_mux_011:sink0_endofpacket
	wire          cmd_demux_001_src1_valid;                                                  // cmd_demux_001:src1_valid -> mux_pipeline_013:in_valid
	wire  [114:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> mux_pipeline_013:in_data
	wire          cmd_demux_001_src1_ready;                                                  // mux_pipeline_013:in_ready -> cmd_demux_001:src1_ready
	wire   [11:0] cmd_demux_001_src1_channel;                                                // cmd_demux_001:src1_channel -> mux_pipeline_013:in_channel
	wire          cmd_demux_001_src1_startofpacket;                                          // cmd_demux_001:src1_startofpacket -> mux_pipeline_013:in_startofpacket
	wire          cmd_demux_001_src1_endofpacket;                                            // cmd_demux_001:src1_endofpacket -> mux_pipeline_013:in_endofpacket
	wire          mux_pipeline_013_source0_valid;                                            // mux_pipeline_013:out_valid -> cmd_mux_011:sink1_valid
	wire  [114:0] mux_pipeline_013_source0_data;                                             // mux_pipeline_013:out_data -> cmd_mux_011:sink1_data
	wire          mux_pipeline_013_source0_ready;                                            // cmd_mux_011:sink1_ready -> mux_pipeline_013:out_ready
	wire   [11:0] mux_pipeline_013_source0_channel;                                          // mux_pipeline_013:out_channel -> cmd_mux_011:sink1_channel
	wire          mux_pipeline_013_source0_startofpacket;                                    // mux_pipeline_013:out_startofpacket -> cmd_mux_011:sink1_startofpacket
	wire          mux_pipeline_013_source0_endofpacket;                                      // mux_pipeline_013:out_endofpacket -> cmd_mux_011:sink1_endofpacket
	wire          rsp_demux_src0_valid;                                                      // rsp_demux:src0_valid -> mux_pipeline_014:in_valid
	wire  [114:0] rsp_demux_src0_data;                                                       // rsp_demux:src0_data -> mux_pipeline_014:in_data
	wire          rsp_demux_src0_ready;                                                      // mux_pipeline_014:in_ready -> rsp_demux:src0_ready
	wire   [11:0] rsp_demux_src0_channel;                                                    // rsp_demux:src0_channel -> mux_pipeline_014:in_channel
	...
	wire  [114:0] mux_pipeline_014_source0_data;                                             // mux_pipeline_014:out_data -> rsp_mux:sink0_data
	wire          mux_pipeline_014_source0_ready;                                            // rsp_mux:sink0_ready -> mux_pipeline_014:out_ready
	wire   [11:0] mux_pipeline_014_source0_channel;                                          // mux_pipeline_014:out_channel -> rsp_mux:sink0_channel
	...
	wire  [114:0] rsp_demux_001_src0_data;                                                   // rsp_demux_001:src0_data -> mux_pipeline_015:in_data
	wire          rsp_demux_001_src0_ready;                                                  // mux_pipeline_015:in_ready -> rsp_demux_001:src0_ready
	wire   [11:0] rsp_demux_001_src0_channel;                                                // rsp_demux_001:src0_channel -> mux_pipeline_015:in_channel
	...
	wire  [114:0] mux_pipeline_015_source0_data;                                             // mux_pipeline_015:out_data -> rsp_mux:sink1_data
	wire          mux_pipeline_015_source0_ready;                                            // rsp_mux:sink1_ready -> mux_pipeline_015:out_ready
	wire   [11:0] mux_pipeline_015_source0_channel;                                          // mux_pipeline_015:out_channel -> rsp_mux:sink1_channel
	...
	wire  [114:0] rsp_demux_002_src0_data;                                                   // rsp_demux_002:src0_data -> mux_pipeline_016:in_data
	wire          rsp_demux_002_src0_ready;                                                  // mux_pipeline_016:in_ready -> rsp_demux_002:src0_ready
	wire   [11:0] rsp_demux_002_src0_channel;                                                // rsp_demux_002:src0_channel -> mux_pipeline_016:in_channel
	...
	wire  [114:0] mux_pipeline_016_source0_data;                                             // mux_pipeline_016:out_data -> rsp_mux:sink2_data
	wire          mux_pipeline_016_source0_ready;                                            // rsp_mux:sink2_ready -> mux_pipeline_016:out_ready
	wire   [11:0] mux_pipeline_016_source0_channel;                                          // mux_pipeline_016:out_channel -> rsp_mux:sink2_channel
	...
	wire  [114:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> mux_pipeline_017:in_data
	wire          rsp_demux_003_src0_ready;                                                  // mux_pipeline_017:in_ready -> rsp_demux_003:src0_ready
	wire   [11:0] rsp_demux_003_src0_channel;                                                // rsp_demux_003:src0_channel -> mux_pipeline_017:in_channel
	...
	wire  [114:0] mux_pipeline_017_source0_data;                                             // mux_pipeline_017:out_data -> rsp_mux:sink3_data
	wire          mux_pipeline_017_source0_ready;                                            // rsp_mux:sink3_ready -> mux_pipeline_017:out_ready
	wire   [11:0] mux_pipeline_017_source0_channel;                                          // mux_pipeline_017:out_channel -> rsp_mux:sink3_channel
	...
	wire  [114:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> mux_pipeline_018:in_data
	...
	wire  [114:0] mux_pipeline_018_source0_data;                                             // mux_pipeline_018:out_data -> rsp_mux:sink4_data
	wire          mux_pipeline_018_source0_ready;                                            // rsp_mux:sink4_ready -> mux_pipeline_018:out_ready
	wire   [11:0] mux_pipeline_018_source0_channel;                                          // mux_pipeline_018:out_channel -> rsp_mux:sink4_channel
	...
	wire  [114:0] rsp_demux_005_src0_data;                                                   // rsp_demux_005:src0_data -> mux_pipeline_019:in_data
	wire          rsp_demux_005_src0_ready;                                                  // mux_pipeline_019:in_ready -> rsp_demux_005:src0_ready
	wire   [11:0] rsp_demux_005_src0_channel;                                                // rsp_demux_005:src0_channel -> mux_pipeline_019:in_channel
	...
	wire  [114:0] mux_pipeline_019_source0_data;                                             // mux_pipeline_019:out_data -> rsp_mux:sink5_data
	wire          mux_pipeline_019_source0_ready;                                            // rsp_mux:sink5_ready -> mux_pipeline_019:out_ready
	wire   [11:0] mux_pipeline_019_source0_channel;                                          // mux_pipeline_019:out_channel -> rsp_mux:sink5_channel
	...
	wire  [114:0] rsp_demux_006_src0_data;                                                   // rsp_demux_006:src0_data -> mux_pipeline_020:in_data
	wire          rsp_demux_006_src0_ready;                                                  // mux_pipeline_020:in_ready -> rsp_demux_006:src0_ready
	wire   [11:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> mux_pipeline_020:in_channel
	...
	wire  [114:0] mux_pipeline_020_source0_data;                                             // mux_pipeline_020:out_data -> rsp_mux:sink6_data
	wire          mux_pipeline_020_source0_ready;                                            // rsp_mux:sink6_ready -> mux_pipeline_020:out_ready
	wire   [11:0] mux_pipeline_020_source0_channel;                                          // mux_pipeline_020:out_channel -> rsp_mux:sink6_channel
	...
	wire          rsp_demux_007_src0_valid;                                                  // rsp_demux_007:src0_valid -> mux_pipeline_021:in_valid
	wire  [114:0] rsp_demux_007_src0_data;                                                   // rsp_demux_007:src0_data -> mux_pipeline_021:in_data
	wire          rsp_demux_007_src0_ready;                                                  // mux_pipeline_021:in_ready -> rsp_demux_007:src0_ready
	wire   [11:0] rsp_demux_007_src0_channel;                                                // rsp_demux_007:src0_channel -> mux_pipeline_021:in_channel
	wire          rsp_demux_007_src0_startofpacket;                                          // rsp_demux_007:src0_startofpacket -> mux_pipeline_021:in_startofpacket
	wire          rsp_demux_007_src0_endofpacket;                                            // rsp_demux_007:src0_endofpacket -> mux_pipeline_021:in_endofpacket
	wire          mux_pipeline_021_source0_valid;                                            // mux_pipeline_021:out_valid -> rsp_mux:sink7_valid
	wire  [114:0] mux_pipeline_021_source0_data;                                             // mux_pipeline_021:out_data -> rsp_mux:sink7_data
	wire          mux_pipeline_021_source0_ready;                                            // rsp_mux:sink7_ready -> mux_pipeline_021:out_ready
	wire   [11:0] mux_pipeline_021_source0_channel;                                          // mux_pipeline_021:out_channel -> rsp_mux:sink7_channel
	wire          mux_pipeline_021_source0_startofpacket;                                    // mux_pipeline_021:out_startofpacket -> rsp_mux:sink7_startofpacket
	wire          mux_pipeline_021_source0_endofpacket;                                      // mux_pipeline_021:out_endofpacket -> rsp_mux:sink7_endofpacket
	wire          rsp_demux_008_src0_valid;                                                  // rsp_demux_008:src0_valid -> mux_pipeline_022:in_valid
	wire  [114:0] rsp_demux_008_src0_data;                                                   // rsp_demux_008:src0_data -> mux_pipeline_022:in_data
	wire          rsp_demux_008_src0_ready;                                                  // mux_pipeline_022:in_ready -> rsp_demux_008:src0_ready
	wire   [11:0] rsp_demux_008_src0_channel;                                                // rsp_demux_008:src0_channel -> mux_pipeline_022:in_channel
	...
	wire          mux_pipeline_022_source0_valid;                                            // mux_pipeline_022:out_valid -> rsp_mux:sink8_valid
	wire  [114:0] mux_pipeline_022_source0_data;                                             // mux_pipeline_022:out_data -> rsp_mux:sink8_data
	wire          mux_pipeline_022_source0_ready;                                            // rsp_mux:sink8_ready -> mux_pipeline_022:out_ready
	wire   [11:0] mux_pipeline_022_source0_channel;                                          // mux_pipeline_022:out_channel -> rsp_mux:sink8_channel
	wire          mux_pipeline_022_source0_startofpacket;                                    // mux_pipeline_022:out_startofpacket -> rsp_mux:sink8_startofpacket
	wire          mux_pipeline_022_source0_endofpacket;                                      // mux_pipeline_022:out_endofpacket -> rsp_mux:sink8_endofpacket
	wire          rsp_demux_009_src0_valid;                                                  // rsp_demux_009:src0_valid -> mux_pipeline_023:in_valid
	wire  [114:0] rsp_demux_009_src0_data;                                                   // rsp_demux_009:src0_data -> mux_pipeline_023:in_data
	wire          rsp_demux_009_src0_ready;                                                  // mux_pipeline_023:in_ready -> rsp_demux_009:src0_ready
	wire   [11:0] rsp_demux_009_src0_channel;                                                // rsp_demux_009:src0_channel -> mux_pipeline_023:in_channel
	wire          rsp_demux_009_src0_startofpacket;                                          // rsp_demux_009:src0_startofpacket -> mux_pipeline_023:in_startofpacket
	wire          rsp_demux_009_src0_endofpacket;                                            // rsp_demux_009:src0_endofpacket -> mux_pipeline_023:in_endofpacket
	wire          mux_pipeline_023_source0_valid;                                            // mux_pipeline_023:out_valid -> rsp_mux:sink9_valid
	wire  [114:0] mux_pipeline_023_source0_data;                                             // mux_pipeline_023:out_data -> rsp_mux:sink9_data
	wire          mux_pipeline_023_source0_ready;                                            // rsp_mux:sink9_ready -> mux_pipeline_023:out_ready
	wire   [11:0] mux_pipeline_023_source0_channel;                                          // mux_pipeline_023:out_channel -> rsp_mux:sink9_channel
	wire          mux_pipeline_023_source0_startofpacket;                                    // mux_pipeline_023:out_startofpacket -> rsp_mux:sink9_startofpacket
	wire          mux_pipeline_023_source0_endofpacket;                                      // mux_pipeline_023:out_endofpacket -> rsp_mux:sink9_endofpacket
	wire          rsp_demux_010_src0_valid;                                                  // rsp_demux_010:src0_valid -> mux_pipeline_024:in_valid
	wire  [114:0] rsp_demux_010_src0_data;                                                   // rsp_demux_010:src0_data -> mux_pipeline_024:in_data
	wire          rsp_demux_010_src0_ready;                                                  // mux_pipeline_024:in_ready -> rsp_demux_010:src0_ready
	wire   [11:0] rsp_demux_010_src0_channel;                                                // rsp_demux_010:src0_channel -> mux_pipeline_024:in_channel
	wire          rsp_demux_010_src0_startofpacket;                                          // rsp_demux_010:src0_startofpacket -> mux_pipeline_024:in_startofpacket
	wire          rsp_demux_010_src0_endofpacket;                                            // rsp_demux_010:src0_endofpacket -> mux_pipeline_024:in_endofpacket
	wire          mux_pipeline_024_source0_valid;                                            // mux_pipeline_024:out_valid -> rsp_mux:sink10_valid
	wire  [114:0] mux_pipeline_024_source0_data;                                             // mux_pipeline_024:out_data -> rsp_mux:sink10_data
	wire          mux_pipeline_024_source0_ready;                                            // rsp_mux:sink10_ready -> mux_pipeline_024:out_ready
	wire   [11:0] mux_pipeline_024_source0_channel;                                          // mux_pipeline_024:out_channel -> rsp_mux:sink10_channel
	wire          mux_pipeline_024_source0_startofpacket;                                    // mux_pipeline_024:out_startofpacket -> rsp_mux:sink10_startofpacket
	wire          mux_pipeline_024_source0_endofpacket;                                      // mux_pipeline_024:out_endofpacket -> rsp_mux:sink10_endofpacket
	wire          rsp_demux_011_src0_valid;                                                  // rsp_demux_011:src0_valid -> mux_pipeline_025:in_valid
	wire  [114:0] rsp_demux_011_src0_data;                                                   // rsp_demux_011:src0_data -> mux_pipeline_025:in_data
	wire          rsp_demux_011_src0_ready;                                                  // mux_pipeline_025:in_ready -> rsp_demux_011:src0_ready
	wire   [11:0] rsp_demux_011_src0_channel;                                                // rsp_demux_011:src0_channel -> mux_pipeline_025:in_channel
	wire          rsp_demux_011_src0_startofpacket;                                          // rsp_demux_011:src0_startofpacket -> mux_pipeline_025:in_startofpacket
	wire          rsp_demux_011_src0_endofpacket;                                            // rsp_demux_011:src0_endofpacket -> mux_pipeline_025:in_endofpacket
	wire          mux_pipeline_025_source0_valid;                                            // mux_pipeline_025:out_valid -> rsp_mux:sink11_valid
	wire  [114:0] mux_pipeline_025_source0_data;                                             // mux_pipeline_025:out_data -> rsp_mux:sink11_data
	wire          mux_pipeline_025_source0_ready;                                            // rsp_mux:sink11_ready -> mux_pipeline_025:out_ready
	wire   [11:0] mux_pipeline_025_source0_channel;                                          // mux_pipeline_025:out_channel -> rsp_mux:sink11_channel
	wire          mux_pipeline_025_source0_startofpacket;                                    // mux_pipeline_025:out_startofpacket -> rsp_mux:sink11_startofpacket
	wire          mux_pipeline_025_source0_endofpacket;                                      // mux_pipeline_025:out_endofpacket -> rsp_mux:sink11_endofpacket
	wire          rsp_demux_003_src1_valid;                                                  // rsp_demux_003:src1_valid -> mux_pipeline_026:in_valid
	wire  [114:0] rsp_demux_003_src1_data;                                                   // rsp_demux_003:src1_data -> mux_pipeline_026:in_data
	wire          rsp_demux_003_src1_ready;                                                  // mux_pipeline_026:in_ready -> rsp_demux_003:src1_ready
	wire   [11:0] rsp_demux_003_src1_channel;                                                // rsp_demux_003:src1_channel -> mux_pipeline_026:in_channel
	wire          rsp_demux_003_src1_startofpacket;                                          // rsp_demux_003:src1_startofpacket -> mux_pipeline_026:in_startofpacket
	wire          rsp_demux_003_src1_endofpacket;                                            // rsp_demux_003:src1_endofpacket -> mux_pipeline_026:in_endofpacket
	wire          mux_pipeline_026_source0_valid;                                            // mux_pipeline_026:out_valid -> rsp_mux_001:sink0_valid
	wire  [114:0] mux_pipeline_026_source0_data;                                             // mux_pipeline_026:out_data -> rsp_mux_001:sink0_data
	...
	wire          rsp_demux_011_src1_valid;                                                  // rsp_demux_011:src1_valid -> mux_pipeline_027:in_valid
	wire  [114:0] rsp_demux_011_src1_data;                                                   // rsp_demux_011:src1_data -> mux_pipeline_027:in_data
	wire          rsp_demux_011_src1_ready;                                                  // mux_pipeline_027:in_ready -> rsp_demux_011:src1_ready
	wire   [11:0] rsp_demux_011_src1_channel;                                                // rsp_demux_011:src1_channel -> mux_pipeline_027:in_channel
	wire          rsp_demux_011_src1_startofpacket;                                          // rsp_demux_011:src1_startofpacket -> mux_pipeline_027:in_startofpacket
	wire          rsp_demux_011_src1_endofpacket;                                            // rsp_demux_011:src1_endofpacket -> mux_pipeline_027:in_endofpacket
	wire          mux_pipeline_027_source0_valid;                                            // mux_pipeline_027:out_valid -> rsp_mux_001:sink1_valid
	wire  [114:0] mux_pipeline_027_source0_data;                                             // mux_pipeline_027:out_data -> rsp_mux_001:sink1_data
	...
	wire          lpddr2_avl_0_agent_rdata_fifo_src_valid;                                   // lpddr2_avl_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] lpddr2_avl_0_agent_rdata_fifo_src_data;                                    // lpddr2_avl_0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          lpddr2_avl_0_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> lpddr2_avl_0_agent:rdata_fifo_src_ready
	...
	wire          timer_1_s1_agent_rdata_fifo_src_valid;                                     // timer_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] timer_1_s1_agent_rdata_fifo_src_data;                                      // timer_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          timer_1_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> timer_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> timer_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> timer_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                         // timer_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> timer_1_s1_agent:rdata_fifo_sink_error
	...
	wire          i2c_scl_s1_agent_rdata_fifo_src_valid;                                     // i2c_scl_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] i2c_scl_s1_agent_rdata_fifo_src_data;                                      // i2c_scl_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          i2c_scl_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_009:in_0_ready -> i2c_scl_s1_agent:rdata_fifo_src_ready
	...
	wire          i2c_sda_s1_agent_rdata_fifo_src_valid;                                     // i2c_sda_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] i2c_sda_s1_agent_rdata_fifo_src_data;                                      // i2c_sda_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          i2c_sda_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_010:in_0_ready -> i2c_sda_s1_agent:rdata_fifo_src_ready
	...
	wire          sram_uas_agent_rdata_fifo_out_valid;                                       // sram_uas_agent_rdata_fifo:out_valid -> avalon_st_adapter_011:in_0_valid
	wire   [17:0] sram_uas_agent_rdata_fifo_out_data;                                        // sram_uas_agent_rdata_fifo:out_data -> avalon_st_adapter_011:in_0_data
	wire          sram_uas_agent_rdata_fifo_out_ready;                                       // avalon_st_adapter_011:in_0_ready -> sram_uas_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> sram_uas_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> sram_uas_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // sram_uas_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> sram_uas_agent:rdata_fifo_sink_error
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_003 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_004 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_006 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_007 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_008 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_009 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_010 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_011 (
	...
	ECE423_QSYS_mm_interconnect_0_router_002 router_012 (
	...
	ECE423_QSYS_mm_interconnect_0_router_013 router_013 (
	...
	ECE423_QSYS_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_125_clk_clk),                         //       clk.clk
		.reset               (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_125_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_cmd_mux_003 cmd_mux_011 (
		.clk                 (clk_125_clk_clk),                         //       clk.clk
		.reset               (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_125_clk_clk),                         //       clk.clk
		.reset              (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_125_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_cmd_demux_001 rsp_demux_011 (
		.clk                (clk_125_clk_clk),                              //       clk.clk
		.reset              (sysid_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	ECE423_QSYS_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink2_ready          (mux_pipeline_016_source0_ready),         //     sink2.ready
		.sink2_valid          (mux_pipeline_016_source0_valid),         //          .valid
		.sink2_channel        (mux_pipeline_016_source0_channel),       //          .channel
		.sink2_data           (mux_pipeline_016_source0_data),          //          .data
		.sink2_startofpacket  (mux_pipeline_016_source0_startofpacket), //          .startofpacket
		.sink2_endofpacket    (mux_pipeline_016_source0_endofpacket),   //          .endofpacket
		.sink3_ready          (mux_pipeline_017_source0_ready),         //     sink3.ready
		.sink3_valid          (mux_pipeline_017_source0_valid),         //          .valid
		.sink3_channel        (mux_pipeline_017_source0_channel),       //          .channel
		.sink3_data           (mux_pipeline_017_source0_data),          //          .data
		.sink3_startofpacket  (mux_pipeline_017_source0_startofpacket), //          .startofpacket
		.sink3_endofpacket    (mux_pipeline_017_source0_endofpacket),   //          .endofpacket
		.sink4_ready          (mux_pipeline_018_source0_ready),         //     sink4.ready
		.sink4_valid          (mux_pipeline_018_source0_valid),         //          .valid
		.sink4_channel        (mux_pipeline_018_source0_channel),       //          .channel
		.sink4_data           (mux_pipeline_018_source0_data),          //          .data
		.sink4_startofpacket  (mux_pipeline_018_source0_startofpacket), //          .startofpacket
		.sink4_endofpacket    (mux_pipeline_018_source0_endofpacket),   //          .endofpacket
		.sink5_ready          (mux_pipeline_019_source0_ready),         //     sink5.ready
		.sink5_valid          (mux_pipeline_019_source0_valid),         //          .valid
		.sink5_channel        (mux_pipeline_019_source0_channel),       //          .channel
		.sink5_data           (mux_pipeline_019_source0_data),          //          .data
		.sink5_startofpacket  (mux_pipeline_019_source0_startofpacket), //          .startofpacket
		.sink5_endofpacket    (mux_pipeline_019_source0_endofpacket),   //          .endofpacket
		.sink6_ready          (mux_pipeline_020_source0_ready),         //     sink6.ready
		.sink6_valid          (mux_pipeline_020_source0_valid),         //          .valid
		.sink6_channel        (mux_pipeline_020_source0_channel),       //          .channel
		.sink6_data           (mux_pipeline_020_source0_data),          //          .data
		.sink6_startofpacket  (mux_pipeline_020_source0_startofpacket), //          .startofpacket
		.sink6_endofpacket    (mux_pipeline_020_source0_endofpacket),   //          .endofpacket
		.sink7_ready          (mux_pipeline_021_source0_ready),         //     sink7.ready
		.sink7_valid          (mux_pipeline_021_source0_valid),         //          .valid
		.sink7_channel        (mux_pipeline_021_source0_channel),       //          .channel
		.sink7_data           (mux_pipeline_021_source0_data),          //          .data
		.sink7_startofpacket  (mux_pipeline_021_source0_startofpacket), //          .startofpacket
		.sink7_endofpacket    (mux_pipeline_021_source0_endofpacket),   //          .endofpacket
		.sink8_ready          (mux_pipeline_022_source0_ready),         //     sink8.ready
		.sink8_valid          (mux_pipeline_022_source0_valid),         //          .valid
		.sink8_channel        (mux_pipeline_022_source0_channel),       //          .channel
		.sink8_data           (mux_pipeline_022_source0_data),          //          .data
		.sink8_startofpacket  (mux_pipeline_022_source0_startofpacket), //          .startofpacket
		.sink8_endofpacket    (mux_pipeline_022_source0_endofpacket),   //          .endofpacket
		.sink9_ready          (mux_pipeline_023_source0_ready),         //     sink9.ready
		.sink9_valid          (mux_pipeline_023_source0_valid),         //          .valid
		.sink9_channel        (mux_pipeline_023_source0_channel),       //          .channel
		.sink9_data           (mux_pipeline_023_source0_data),          //          .data
		.sink9_startofpacket  (mux_pipeline_023_source0_startofpacket), //          .startofpacket
		.sink9_endofpacket    (mux_pipeline_023_source0_endofpacket),   //          .endofpacket
		.sink10_ready         (mux_pipeline_024_source0_ready),         //    sink10.ready
		.sink10_valid         (mux_pipeline_024_source0_valid),         //          .valid
		.sink10_channel       (mux_pipeline_024_source0_channel),       //          .channel
		.sink10_data          (mux_pipeline_024_source0_data),          //          .data
		.sink10_startofpacket (mux_pipeline_024_source0_startofpacket), //          .startofpacket
		.sink10_endofpacket   (mux_pipeline_024_source0_endofpacket),   //          .endofpacket
		.sink11_ready         (mux_pipeline_025_source0_ready),         //    sink11.ready
		.sink11_valid         (mux_pipeline_025_source0_valid),         //          .valid
		.sink11_channel       (mux_pipeline_025_source0_channel),       //          .channel
		.sink11_data          (mux_pipeline_025_source0_data),          //          .data
		.sink11_startofpacket (mux_pipeline_025_source0_startofpacket), //          .startofpacket
		.sink11_endofpacket   (mux_pipeline_025_source0_endofpacket)    //          .endofpacket
	);
	...
	ECE423_QSYS_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (lpddr2_avl_0_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (lpddr2_avl_0_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (lpddr2_avl_0_agent_rdata_fifo_src_ready), //         .ready
	...
	ECE423_QSYS_mm_interconnect_0_avalon_st_adapter_011 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
